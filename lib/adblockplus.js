  ...
  Downloader.prototype = {
    ...
    _download: function(downloadable, redirects)
    {
      ...
      var errorCallback = function errorCallback(error)
      {
        ...
        Cu.reportError("Funny Adblock: Downloading URL " + downloadable.url + " failed (" + error + ")\n" + "Download address: " + downloadUrl + "\n" + "Channel status: " + channelStatus + "\n" + "Server response: " + responseStatus);
...
require.scopes["filterStorage"] = (function()
{
  ...
  var FilterStorage = exports.FilterStorage = {
    ...
    get sourceFile()
    {
      ...
      if (!file)
      {
        Cu.reportError("Funny Adblock: Failed to resolve filter file location from extensions.adblockplus.patternsfile preference");
      }
    ...
    {
      var _generatorResult38 = [];
      _generatorResult38.push("# Funny Adblock preferences");
